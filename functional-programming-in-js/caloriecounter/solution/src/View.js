...
const { 
    pre, div, h1, button, form, label, input,
    ...
    if(showForm) {
        return form(
            ...
            [
                ...
                fieldSet('Calories', calories || '', //0 is falsy, check Truthy value: https://developer.mozilla.org/en-US/docs/Glossary/Truthy
...
function view(dispatch, model) {
    return div({ className: 'mw6 center' }, [
        ...
        // pre(JSON.stringify(model, null, 2)), //needed for dev mode
    ]);
